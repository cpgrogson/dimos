...
from dimos.robot.deep_robotics.protocol import (
    HEADER_LEN,
    HEADER_MAGIC,
    JSON_FORMAT,
    Command,
...
from dimos.robot.deep_robotics.m20.velocity_controller import (
    M20SpeedLimits,
    M20VelocityController,
    VelocityState,
)
from dimos.robot.deep_robotics.m20.odometry import M20DeadReckonOdometry
...
class TestROSSensorConversions:
    ...
    def test_odom_to_pose_stamped(self):
        ...
        from dimos.robot.deep_robotics.m20.ros_sensors import _odom_to_pose_stamped
    ...
    def test_ros_pc2_to_dimos_basic(self):
        ...
        from dimos.robot.deep_robotics.m20.ros_sensors import _ros_pc2_to_dimos
    ...
    def test_motion_info_to_data(self):
        ...
        from dimos.robot.deep_robotics.m20.ros_sensors import (
            MotionInfoData,
    ...
    def test_drdds_header_field_detection(self):
        ...
        from dimos.robot.deep_robotics.m20.ros_sensors import _DRDDS_HEADER_FIELD
    ...
    def test_tf_to_transforms(self):
        ...
        from dimos.robot.deep_robotics.m20.ros_sensors import _tf_to_transforms
...
class TestBlueprintSmoke:
    ...
    def test_m20_minimal_is_blueprint(self):
        ...
        try:
            from dimos.robot.deep_robotics.m20.blueprints.basic.m20_minimal import (
                m20_minimal,
            )
    ...
    def test_m20_smart_is_blueprint(self):
        ...
        try:
            from dimos.robot.deep_robotics.m20.blueprints.smart.m20_smart import (
                m20_smart,
            )
        except ModuleNotFoundError as e:
            if e.name in self.OPTIONAL_DEPS:
    ...
    def test_m20_agentic_is_blueprint(self):
        ...
        try:
            from dimos.robot.deep_robotics.m20.blueprints.agentic.m20_agentic import (
                m20_agentic,
            )
        except ModuleNotFoundError as e:
            if e.name in self.OPTIONAL_DEPS:
    ...
    def test_m20_skills_blueprint_export(self):
        from dimos.robot.deep_robotics.m20.skill_container import m20_skills
...
class TestMacBridgeProtocol:
    ...
    def test_json_frame_encode_decode(self):
        ...
        from dimos.robot.deep_robotics.m20.mac_bridge_client import (
            MSG_ODOM,
            FrameProtocol,
        )
...
class TestMacBridgeClientDispatch:
    ...
    def test_odom_frame_produces_pose_stamped(self):
        ...
        from dimos.robot.deep_robotics.m20.mac_bridge_client import _decode_odom
    ...
    def test_lidar_frame_produces_point_cloud(self):
        ...
        from dimos.robot.deep_robotics.m20.mac_bridge_client import _decode_lidar
    ...
    def test_motion_info_frame_produces_named_tuple(self):
        ...
        from dimos.robot.deep_robotics.m20.mac_bridge_client import _decode_motion_info
        from dimos.robot.deep_robotics.m20.ros_sensors import MotionInfoData
    ...
    def test_nav_cmd_available_always_true(self):
        ...
        from dimos.robot.deep_robotics.m20.mac_bridge_client import M20MacBridgeClient
