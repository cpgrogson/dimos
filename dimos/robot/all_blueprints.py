...
all_blueprints = {
    ...
    "mid360cpp": "dimos.hardware.sensors.lidar.livox.livox_blueprints:mid360cpp",
...
all_modules = {
    ...
    "livox_lidar_module": "dimos.hardware.sensors.lidar.livox.module",
    ...
    "mid360_cpp_module": "dimos.hardware.sensors.lidar.livox.cpp.module",
